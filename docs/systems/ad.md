...
| `draw.ad.button` | 광고보기 | Watch Ad | 타워 뽑기 |
...
- **위치**: TowerPanel 하단 우측 (X=240, Y=PANEL_Y+50), 뽑기 버튼(X=80) 오른쪽
- **크기**: 120x44px (뽑기 버튼과 동일)
- **배경**: `slot_action_normal` 텍스처, 폴백 사각형(0x1a1a2e, BTN_META 테두리)
- **텍스트**: 상단 "광고보기" (i18n: `draw.ad.button`), 하단 "타워 3선택" (i18n: `draw.ad.sublabel`, 연보라 #9b59b6)
