...
| `js/config.js` | 모든 게임 상수/밸런스 수치 집중 관리 (타워 10종, 적 8종, 웨이브 R1~R20, 메타 업그레이드 트리, 유틸리티 업그레이드, 저항 캡 0.55, 골드 싱크 상수, 머지 레시피 85종/스탯 85종 (T2 55종 + T3 30종), 세이브 마이그레이션 v2) |
...
| 문서 | 내용 |
|---|---|
| [systems/tower.md](systems/tower.md) | 타워 10종(Lv.1), T2 합성 55종, T3 합성 30종, 공격타입 7종, 머지 시스템, 강화 시스템 |
