...
export const WORLDS = [
  {
    ...
    theme: THEME_FOREST,
    mapIds: ['f1_m1', 'f1_m2', 'f1_m3', 'f1_m4', 'f1_m5', 'f1_m6'],
    requiredStars: 0,
    order: 1,
  },
  {
    ...
    theme: THEME_DESERT,
    mapIds: ['d2_m1', 'd2_m2', 'd2_m3', 'd2_m4', 'd2_m5', 'd2_m6'],
    requiredStars: 9,
    order: 2,
  },
  {
    ...
    theme: THEME_TUNDRA,
    mapIds: ['t3_m1', 't3_m2', 't3_m3', 't3_m4', 't3_m5', 't3_m6'],
    requiredStars: 24,
    order: 3,
  },
  {
    ...
    theme: THEME_VOLCANO,
    mapIds: ['v4_m1', 'v4_m2', 'v4_m3', 'v4_m4', 'v4_m5', 'v4_m6'],
    requiredStars: 42,
    order: 4,
  },
  {
    ...
    theme: THEME_SHADOW,
    mapIds: ['s5_m1', 's5_m2', 's5_m3', 's5_m4', 's5_m5', 's5_m6'],
    requiredStars: 60,
    order: 5,
  },
];
