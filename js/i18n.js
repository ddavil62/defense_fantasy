...
const STRINGS = {
  ko: {
    ...
    // ── 글로벌 메타 업그레이드 ──
    // 카테고리 헤더
    'meta.category.combat': '전투',
    'meta.category.economy': '경제',
    'meta.category.survival': '생존',
    'meta.category.growth': '성장',
    // 업그레이드 이름
    'meta.upgrade.damage': '공격력',
    'meta.upgrade.fireRate': '공격속도',
    'meta.upgrade.range': '사거리',
    'meta.upgrade.startGold': '시작 골드',
    'meta.upgrade.killGold': '처치 골드',
    'meta.upgrade.drawDiscount': '뽑기 할인',
    'meta.upgrade.mergeDiscount': '합성 할인',
    'meta.upgrade.baseHp': '기지 체력',
    'meta.upgrade.waveBonus': '웨이브 보너스',
    'meta.upgrade.diamondBonus': '다이아 보너스',
    // 업그레이드 설명
    'meta.desc.damage': '모든 타워의 공격력 증가',
    'meta.desc.fireRate': '모든 타워의 공격 간격 감소',
    'meta.desc.range': '모든 타워의 사거리 증가',
    'meta.desc.startGold': '게임 시작 시 보유 골드 증가',
    'meta.desc.killGold': '적 처치 시 획득 골드 증가',
    'meta.desc.drawDiscount': '타워 뽑기 비용 할인',
    'meta.desc.mergeDiscount': '타워 합성 비용 할인',
    'meta.desc.baseHp': '기지 시작 체력 증가',
    'meta.desc.waveBonus': '웨이브 클리어 보너스 골드 증가',
    'meta.desc.diamondBonus': '게임 종료 시 다이아몬드 보상 증가',
    // 메타 UI
    'meta.level': 'Lv.{cur}/{max}',
    'meta.bonus.percent': '+{pct}%',
    'meta.bonus.flat': '+{val}',
    'meta.bonus.discount': '-{pct}%',
    'meta.max': 'MAX',
    'meta.upgrade.button': '강화',
    'meta.refund.toast': '기존 업그레이드 \u25C6{amount} 환불!',
    // 컬렉션 UI
    ...
    'draw.ad.modal.cancel': '취소',
    'draw.ad.failed': '광고를 불러올 수 없습니다',
    'draw.ad.badge.t1': 'T1',
    'draw.ad.badge.t2': 'T2 ★',
    ...
    'iap.removeAds.confirmDesc': '모든 보상형 광고가\n무제한 무료로 바뀝니다',
    'iap.removeAds.confirmYes': '구매하기',
    'iap.removeAds.confirmNo': '취소',
    ...
    'gameover.diamondTotal': '(총: ◆ {total})',
    'gameover.noDiamond': '5라운드 이상 시 다이아 보상',
    'gameover.retry': '재도전',
    'gameover.menu': '메뉴',
    // ── 일시정지 오버레이 (GameScene) ──
    'pause.title': '일시정지',
    ...
    'menu.collection': '컬렉션',
    'menu.statistics': '통계',
    'menu.best': '최고: 라운드 {round}',
    'menu.record': '처치: {kills} | 게임: {games}',
  ...
  en: {
    ...
    // ── Global meta upgrades ──
    // Category headers
    'meta.category.combat': 'Combat',
    'meta.category.economy': 'Economy',
    'meta.category.survival': 'Survival',
    'meta.category.growth': 'Growth',
    // Upgrade names
    'meta.upgrade.damage': 'Attack Power',
    'meta.upgrade.fireRate': 'Attack Speed',
    'meta.upgrade.range': 'Range',
    'meta.upgrade.startGold': 'Starting Gold',
    'meta.upgrade.killGold': 'Kill Gold',
    'meta.upgrade.drawDiscount': 'Draw Discount',
    'meta.upgrade.mergeDiscount': 'Merge Discount',
    'meta.upgrade.baseHp': 'Base HP',
    'meta.upgrade.waveBonus': 'Wave Bonus',
    'meta.upgrade.diamondBonus': 'Diamond Bonus',
    // Upgrade descriptions
    'meta.desc.damage': 'Increase all tower damage',
    'meta.desc.fireRate': 'Reduce all tower attack interval',
    'meta.desc.range': 'Increase all tower range',
    'meta.desc.startGold': 'Increase starting gold',
    'meta.desc.killGold': 'Increase gold from enemy kills',
    'meta.desc.drawDiscount': 'Reduce tower draw cost',
    'meta.desc.mergeDiscount': 'Reduce tower merge cost',
    'meta.desc.baseHp': 'Increase base starting HP',
    'meta.desc.waveBonus': 'Increase wave clear bonus gold',
    'meta.desc.diamondBonus': 'Increase diamond rewards',
    // Meta UI
    'meta.level': 'Lv.{cur}/{max}',
    'meta.bonus.percent': '+{pct}%',
    'meta.bonus.flat': '+{val}',
    'meta.bonus.discount': '-{pct}%',
    'meta.max': 'MAX',
    'meta.upgrade.button': 'Upgrade',
    'meta.refund.toast': 'Refunded \u25C6{amount} from previous upgrades!',
    // Collection UI
    ...
    'draw.ad.modal.cancel': 'Cancel',
    'draw.ad.failed': 'Ad unavailable',
    'draw.ad.badge.t1': 'T1',
    'draw.ad.badge.t2': 'T2 ★',
    ...
    'iap.removeAds.confirmDesc': 'All rewarded ads become\nunlimited & free',
    'iap.removeAds.confirmYes': 'Purchase',
    'iap.removeAds.confirmNo': 'Cancel',
